...
function loadError(layerId, geoDataSrc, error) {
  ...
  var target = $('#' + layerId);
  $('<div class="ui card layer-sliders" style="display:block"><div class="content"><div class="ui divided list"><div class="item"><i class="circular inverted warning icon"></i><div class="content"><div class="header">Load Failed</div>Please use <a href="mailto:info@nostradamiq.org?subject=MOM WorldBrowser 3D broken link - ' + layerId + '&amp;body=Unfortunately this ( ' + geoDataSrc + ' ) URL is not working properly due to ( ' + error + ' ), please look into it.  Sent from http://nostradamiq.org/webapp/" target="_self">this link</a> to report this error.<br><br><strong>ERROR:</strong> ' + error + '</div></div></div></div>').appendTo(target);
...
function initDetails(layerId, layerType, details, source, sourceUrl, geoDataSrc) {
    ...
    $('<div class="details-bottom-content"><a href="' + homeURL + 'index.html?layersOn=' + layerId + '" class="pull-right" target="_self">Share Link</a><a href="mailto:info@nostradamiq.org?subject=MOM WorldBrowser 3D broken link - ' + layerId + '&amp;body=Unfortunately this ( ' + geoDataSrc + ' ) URL is not working properly, please look into it. Sent from http://climateviewer.com/3D/" target="_self">Report Error</a></div>').appendTo(details);
